    ...
    <div className="mt-4 rounded-lg overflow-x-auto">
      ...
      >
        <table id="main-table" class="main-table">
          ...
          <tbody>
            <tr>
              <td rowSpan={4} className="sticky text-center w-72">
            ...
            <tr>
              <td>P</td>
              <td style={{ background: "#88F077", fontWeight: "bold" }}>
                7,097
              </td>
              <td style={{ background: "#88F077", fontWeight: "bold" }}>
                7,097
            ...
            <tr>
              <div className="custom-sticky mt-1 text-xs text-black font-semibold bg-[#FFA800] w-fit px-5 py-1 rounded-tr-2xl">
                Rank B
              </div>
            </tr>
            <tr>
