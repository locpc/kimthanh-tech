...
const DataTable = () => {
  ...
  return(
  <div className="mt-4">
    <table className="custom-table" style={{ width: "100%", background: "white" }}>
      <tr>
        <th>App</th>
        <th></th>
        <th>Sum</th>
      ...
      <tr>
        <td>P</td>
        <td style={{ background: "#88F077" }}>7,097</td>
        <td style={{ background: "#88F077" }}>7,097</td>
        <td style={{ background: "#88F077" }}>7,097</td>
        <td style={{ background: "#88F077" }}>7,097</td>
        <td style={{ background: "#88F077" }}>7,097</td>
      ...
      <tr>
        <td>%</td>
        <td style={{ background: "#88F077" }}>20.56%</td>
        <td style={{ background: "#88F077" }}>20.56%</td>
        <td style={{ background: "#88F077" }}>20.56%</td>
        <td style={{ background: "#88F077" }}>20.56%</td>
        <td style={{ background: "#88F077" }}>20.56%</td>
      ...
      <tr>
        <td rowSpan={4} className="text-center px-1 cursor-pointer" onClick={onHandleDetails}>
          <div className="flex gap-1 items-center">
            <div className="w-2 h-2 rounded bg-[#00ED34]" />
            <p className="text-xs text-[#A3AED0] font-bold">221</p>
            <p className="text-sm text-main font-bold">File Recovery - Photo Recovery</p>
          </div>
      ...
      <tr>
        ...
        <td style={{ background: "#88F077" }}>7,097</td>
        <td style={{ background: "#88F077" }}>7,097</td>
        <td style={{ background: "#FF0000", color: "white" }}>-7,097</td>
        <td style={{ background: "#88F077" }}>7,097</td>
        <td style={{ background: "#88F077" }}>7,097</td>
        <td style={{ background: "#88F077" }}>7,097</td>
        <td style={{ background: "#88F077" }}>7,097</td>
      ...
      <tr>
        <td rowSpan={4} className="text-center px-1 cursor-pointer" onClick={onHandleDetails}>
          <div className="flex gap-1 items-center">
            <div className="w-2 h-2 rounded bg-[#00ED34]" />
            <p className="text-xs text-[#A3AED0] font-bold">221</p>
            <p className="text-sm text-main font-bold">Talk To Dogs - Dog Translator</p>
          </div>
          <div className="grid grid-cols-2">
            <div className="flex gap-1">
              <p>Doanh thu:</p>
      ...
      <tr>
        <td rowSpan={4} className="text-center px-1 cursor-pointer" onClick={onHandleDetails}>
          <div className="flex gap-1 items-center">
            <div className="w-2 h-2 rounded bg-[#00ED34]" />
            <p className="text-xs text-[#A3AED0] font-bold">221</p>
            <p className="text-sm text-main font-bold">AR Drawing Sketch Paint</p>
          </div>
          <div className="grid grid-cols-2">
            <div className="flex gap-1">
              <p>Doanh thu:</p>
      ...
      <tr>
        <td rowSpan={4} className="text-center px-1 cursor-pointer" onClick={onHandleDetails}>
          <div className="flex gap-1 items-center">
            <div className="w-2 h-2 rounded bg-[#00ED34]" />
            <p className="text-xs text-[#A3AED0] font-bold">221</p>
            <p className="text-sm text-main font-bold">Wifi Password: Wifi Master Key</p>
          </div>
          <div className="grid grid-cols-2">
            <div className="flex gap-1">
              <p>Doanh thu:</p>
